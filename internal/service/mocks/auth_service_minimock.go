...
//go:generate minimock -i github.com/Mobo140/microservices/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
type AuthServiceMock struct {
	...
	funcGetAccessToken          func(ctx context.Context, refreshToken string) (sp1 *string, err error)
	...
	funcLogin          func(ctx context.Context, data *model.LoginData) (sp1 *string, err error)
	funcLoginOrigin    string
	inspectFuncLogin   func(ctx context.Context, data *model.LoginData)
...
func (mmGetAccessToken *mAuthServiceMockGetAccessToken) Set(f func(ctx context.Context, refreshToken string) (sp1 *string, err error)) *AuthServiceMock {
	if mmGetAccessToken.defaultExpectation != nil {
...
func (mmGetAccessToken *AuthServiceMock) GetAccessToken(ctx context.Context, refreshToken string) (sp1 *string, err error) {
...
func (mmGetRefreshToken *mAuthServiceMockGetRefreshToken) ExpectRefreshTokenParam2(refreshToken string) *mAuthServiceMockGetRefreshToken {
	...
	mmGetRefreshToken.defaultExpectation.expectationOrigins.originRefreshToken = minimock.CallerInfo(1)
...
func (mmGetRefreshToken *AuthServiceMock) GetRefreshToken(ctx context.Context, refreshToken string) (sp1 *string, err error) {
	...
	if mmGetRefreshToken.GetRefreshTokenMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.refreshToken != nil && !minimock.Equal(*mm_want_ptrs.refreshToken, mm_got.refreshToken) {
				mmGetRefreshToken.t.Errorf("AuthServiceMock.GetRefreshToken got unexpected parameter refreshToken, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetRefreshToken.GetRefreshTokenMock.defaultExpectation.expectationOrigins.originRefreshToken, *mm_want_ptrs.refreshToken, mm_got.refreshToken, minimock.Diff(*mm_want_ptrs.refreshToken, mm_got.refreshToken))
			}
...
func (mmLogin *mAuthServiceMockLogin) Expect(ctx context.Context, data *model.LoginData) *mAuthServiceMockLogin {
	...
	mmLogin.defaultExpectation.params = &AuthServiceMockLoginParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for AuthService.Login
func (mmLogin *mAuthServiceMockLogin) ExpectDataParam2(data *model.LoginData) *mAuthServiceMockLogin {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("AuthServiceMock.Login mock is already set by Set")
	}
	...
	mmLogin.defaultExpectation.paramPtrs.data = &data
	mmLogin.defaultExpectation.expectationOrigins.originData = minimock.CallerInfo(1)

	return mmLogin
}

// Inspect accepts an inspector function that has same arguments as the AuthService.Login
func (mmLogin *mAuthServiceMockLogin) Inspect(f func(ctx context.Context, data *model.LoginData)) *mAuthServiceMockLogin {
...
func (mmLogin *mAuthServiceMockLogin) Set(f func(ctx context.Context, data *model.LoginData) (sp1 *string, err error)) *AuthServiceMock {
	if mmLogin.defaultExpectation != nil {
...
// Then helper
func (mmLogin *mAuthServiceMockLogin) When(ctx context.Context, data *model.LoginData) *AuthServiceMockLoginExpectation {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("AuthServiceMock.Login mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockLoginExpectation{
		mock:               mmLogin.mock,
		params:             &AuthServiceMockLoginParams{ctx, data},
...
func (mmLogin *AuthServiceMock) Login(ctx context.Context, data *model.LoginData) (sp1 *string, err error) {
	...
	if mmLogin.inspectFuncLogin != nil {
		mmLogin.inspectFuncLogin(ctx, data)
	}

	mm_params := AuthServiceMockLoginParams{ctx, data}
	...
	if mmLogin.LoginMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockLoginParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmLogin.t.Errorf("AuthServiceMock.Login got unexpected parameter data, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmLogin.LoginMock.defaultExpectation.expectationOrigins.originData, *mm_want_ptrs.data, mm_got.data, minimock.Diff(*mm_want_ptrs.data, mm_got.data))
			}
	...
	if mmLogin.funcLogin != nil {
		return mmLogin.funcLogin(ctx, data)
	}
	mmLogin.t.Fatalf("Unexpected call to AuthServiceMock.Login. %v %v", ctx, data)
	return
}
