...
func (mmGet *mUserServiceMockGet) Return(up1 *model.UserInfo, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id int64) (up1 *model.UserInfo, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(up1 *model.UserInfo, err error) *UserServiceMock {
...
func (mmGet *UserServiceMock) Get(ctx context.Context, id int64) (up1 *model.UserInfo, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, userInfo *model.UpdateUserInfo) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, id, userInfo}
...
// ExpectUserInfoParam3 sets up expected param userInfo for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectUserInfoParam3(userInfo *model.UpdateUserInfo) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, userInfo *model.UpdateUserInfo)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, userInfo *model.UpdateUserInfo) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, userInfo *model.UpdateUserInfo) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserServiceMockUpdateParams{ctx, id, userInfo},
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, userInfo *model.UpdateUserInfo) (err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, id, userInfo}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, id, userInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userInfo != nil && !minimock.Equal(*mm_want_ptrs.userInfo, mm_got.userInfo) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter userInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v %v", ctx, id, userInfo)
	return
}
